      ...
      <div className="relative box-border caret-transparent z-0 overflow-hidden py-2.5">
        <div role="region" className="relative box-border caret-transparent">
          <div className="relative box-border caret-transparent z-0 overflow-hidden">
            <div
              role="presentation"
              className="box-border caret-transparent gap-x-10 flex h-full gap-y-10 translate-x-[-4436.49px] md:gap-x-16 md:gap-y-16"
            >
              <div
                role="group"
                aria-label="1 of 39"
              ...
              >
                <img
                  ...
                  alt=""
                  className="box-border caret-transparent h-full max-w-full min-h-[auto] min-w-[auto] object-contain align-bottom w-full md:object-fill md:w-auto"
                />
              </div>
              <div
                role="group"
        ...
        <div role="region" className="relative box-border caret-transparent">
          <div className="relative box-border caret-transparent z-0 overflow-hidden">
            <div
              role="presentation"
              className="box-border caret-transparent gap-x-10 flex h-full gap-y-10 translate-x-[-3394.36px] md:gap-x-16 md:gap-y-16"
            >
              <div
                role="group"
                aria-label="1 of 27"
