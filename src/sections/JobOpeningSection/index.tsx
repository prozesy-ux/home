import { JobCard } from "@/sections/JobOpeningSection/components/JobCard";

export const JobOpeningSection = () => {
  return (
    <section className="relative bg-neutral-950 box-border caret-transparent overflow-hidden rounded-2xl md:rounded-[32px]">
      <div className="box-border caret-transparent px-5 py-[60px] md:px-[94px] md:py-[100px]">
        <div className="box-border caret-transparent max-w-[1252px] w-full mx-auto">
          <div className="box-border caret-transparent flex flex-col gap-y-14">
            <div className="items-center box-border caret-transparent flex flex-col justify-start max-w-[360px] min-h-[auto] min-w-[auto] gap-y-4 text-center w-full mx-auto md:max-w-[642px]">
            ...
            <div className="relative box-border caret-transparent min-h-[auto] min-w-[auto]">
              <div className="box-border caret-transparent">
                <div
                  role="list"
                  className="box-border caret-transparent gap-x-5 flex flex-col gap-y-5"
                >
                  <JobCard />
                </div>
              </div>
      ...
      <div className="absolute box-border caret-transparent hidden left-[0%] top-[0%] md:block">
        <img
          src="https://cdn.prod.website-files.com/672a72b52eb5f37692d645a9/67db041a706632a9c11cb6c6_Ring.avif"
          alt=""
