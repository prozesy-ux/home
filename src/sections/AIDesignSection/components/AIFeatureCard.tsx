  ...
  return (
    <div className="relative bg-[linear-gradient(160deg,rgba(127,33,255,0.6)_0%,rgba(127,33,255,0)_41%,rgba(127,33,255,0)_71%,rgb(127,33,255)_100%)] box-border caret-transparent min-h-[auto] min-w-[auto] w-full z-[1] overflow-hidden rounded-3xl md:overflow-visible md:rounded-[40px] before:accent-auto before:bg-slate-900 before:caret-transparent before:text-zinc-800 before:block before:text-sm before:not-italic before:normal-nums before:font-normal before:tracking-[normal] before:leading-5 before:list-outside before:list-disc before:pointer-events-auto before:absolute before:text-start before:no-underline before:indent-[0px] before:normal-case before:visible before:z-[-1] before:rounded-3xl before:border-separate before:inset-px before:font-outfit_variablefont_wght before:md:rounded-[40px]">
      ...
      <div className="relative box-border caret-transparent gap-x-6 flex flex-col h-full gap-y-6 w-full overflow-hidden pt-7 pb-px px-5 md:gap-x-10 md:gap-y-10 md:pt-8 md:px-8">
        ...
        <div className="box-border caret-transparent min-h-[auto] min-w-[auto] overflow-hidden mt-auto rounded-br-[5px]">
          <img
