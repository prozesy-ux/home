            ...
            <div className="items-center box-border caret-transparent gap-x-8 flex flex-col justify-start gap-y-8 md:gap-x-14 md:gap-y-14">
              ...
              <div className="box-border caret-transparent flex flex-col max-w-[1038px] min-h-[auto] min-w-[auto] w-full">
                ...
                <FAQItem
                  ...
                  secondaryAnswer="We use different industry-leading tools. For pixel-perfect UI/UX and Web designs, we swear by Figma and Figjam. When it comes to crafting visually stunning branding and product designs, our go-to is the Adobe suite, which includes Photoshop, Illustrator, and After Effects. And for seamless project documentation? Notion's got our back. All are aimed at delivering top-quality results."
                  iconUrl="https://c.animaapp.com/mmczzcvjDbxkkG/assets/icon-25.svg"
                />
                <FAQItem
