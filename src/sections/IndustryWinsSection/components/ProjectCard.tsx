export type ProjectCardProps = {
  ...
  mobileTestimonialBgColor: string;
};
...
export const ProjectCard = (props: ProjectCardProps) => {
  return (
    <a
      href={props.href}
      className={`static text-violet-600 items-center box-border caret-transparent gap-x-0 flex flex-col justify-start max-w-full min-h-[auto] min-w-[auto] gap-y-0 rounded-2xl md:sticky md:gap-x-[140px] md:flex-row md:gap-y-[140px] md:pl-10 md:pr-5 md:py-5 ${props.linkClassName}`}
    >
      <div className="relative box-border caret-transparent basis-[0%] grow max-w-full min-h-[auto] min-w-[auto] w-full md:max-w-[470px]">
        ...
        <div className="box-border caret-transparent gap-x-2 grid flex-col auto-cols-[1fr] grid-cols-[1fr_1fr] grid-rows-[auto] gap-y-2 mt-6 py-2.5 md:gap-x-4 md:gap-y-4 md:mt-[38px]">
          <div className="items-start box-border caret-transparent gap-x-1 flex flex-col justify-start min-h-[auto] min-w-[auto] gap-y-1 md:gap-x-2 md:gap-y-2">
        ...
        >
          ...
          <div className="text-base font-bold box-border caret-transparent gap-x-2 flex tracking-[0.32px] leading-6 min-h-0 min-w-0 gap-y-2 font-outfit md:min-h-[auto] md:min-w-[auto]">
            ...
            <img
              src="https://cdn.prod.website-files.com/672a72b52eb5f37692d645a9/6799f28b6dbb92499048ec9a_CTA Arrow (1).svg"
              alt=""
      ...
      <div className="relative items-start box-border caret-transparent flex basis-[0%] grow h-full justify-start max-w-full min-h-[auto] min-w-[auto] w-full mt-6 mb-4 rounded-lg md:w-auto md:my-0">
        <img
          src={props.projectImageUrl}
          alt={props.projectImageAlt}
          className="box-border caret-transparent max-w-full min-h-[auto] min-w-[auto] w-full"
        />
      </div>
      <div
        className={`items-center ${props.mobileTestimonialBgColor} box-border caret-transparent gap-x-2 flex justify-between min-h-[auto] min-w-[auto] gap-y-2 w-full mt-2 px-4 py-2 rounded-lg md:hidden md:min-h-0 md:min-w-0 md:w-auto md:mt-4`}
      >
